      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-6">
          <div className="flex-1">
            <div className="flex items-center mb-4">
              <div className="h-12 w-12 bg-blue-600 rounded-2xl flex items-center justify-center mr-4">
        ...
        {courses.length === 0 ? (
          <div className="bg-white rounded-3xl shadow-xl p-12 text-center border border-gray-100">
            ...
            <a
              href="/"
              className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-8 rounded-2xl transition-all duration-200 inline-flex items-center shadow-lg hover:shadow-xl transform hover:scale-105"
            >
              <FaBook className="mr-2" />
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="bg-blue-50 rounded-2xl p-3 text-center min-w-[70px]">
                  ...
                  {/* Enrollment Status */}
                  <div className="bg-blue-50 text-blue-700 px-4 py-3 rounded-2xl flex items-center justify-center border border-blue-200">
